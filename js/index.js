...
let handleClick = e => { // take the selected button click as 'e' and..
    ...
    resources.dc.innerHTML = `<h1>${contents[currentContent].heading}</h1>
                              <figure>
